...
public interface CiamAuthCodeRepository {
    ...
    /** 根据授权码哈希查询 */
    Optional<CiamAuthCodeDo> findByCodeHash(String codeHash);

    /** 根据业务 ID 查询 */
    Optional<CiamAuthCodeDo> findByAuthCodeId(String authCodeId);

    /** 插入授权码记录 */
    int insert(CiamAuthCodeDo entity);

    /** 根据业务 ID 更新 */
    int updateByAuthCodeId(CiamAuthCodeDo entity);
}
