...
public class StatisticsAppService {
     ...
     * @return 注册统计结果
     */
    public StatisticsResultDto2 getRegistrationStats(LocalDateTime startTime, LocalDateTime endTime, String channel) {
     ...
     * @return 登录统计结果
     */
    public StatisticsResultDto2 getLoginStats(LocalDateTime startTime, LocalDateTime endTime, String clientType) {
     ...
     * @return 渠道分布统计结果
     */
    public StatisticsResultDto2 getChannelDistribution(LocalDateTime startTime, LocalDateTime endTime) {
     ...
     * @return 第三方登录分布统计结果
     */
    public StatisticsResultDto2 getThirdPartyLoginDistribution(LocalDateTime startTime, LocalDateTime endTime) {
