...
import net.hwyz.iov.cloud.sec.ciam.domain.service.AuthCodeExchangeResult;
import net.hwyz.iov.cloud.sec.ciam.domain.service.ClientCredentialsResult;
import net.hwyz.iov.cloud.sec.ciam.domain.service.DeviceAuthorizationResponse;
import net.hwyz.iov.cloud.sec.ciam.domain.service.DeviceAuthorizationResult;
...
import net.hwyz.iov.cloud.sec.ciam.domain.service.RefreshTokenRotationResult;
