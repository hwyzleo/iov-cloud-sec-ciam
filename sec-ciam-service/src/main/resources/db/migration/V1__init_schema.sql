...
-- 1. ciam_user — 用户主表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_user` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_user_identity` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `identity_value`   VARCHAR(255)  NOT NULL                COMMENT '登录标识原值（AES-256-GCM 加密存储）',
  `identity_hash`    CHAR(64)      NOT NULL                COMMENT '登录标识 SHA-256 哈希值（用于唯一查重）',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_user_profile` (
  `id`            BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_user_tag` (
  `id`              BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 6. ciam_session — 会话表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_session` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 7. ciam_device — 设备表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_device` (
  `id`                 BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_refresh_token` (
  `id`                BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  `refresh_token_id`  VARCHAR(64)   NOT NULL                COMMENT '刷新令牌业务唯一标识',
  `user_id`           VARCHAR(64)   NOT NULL                COMMENT '用户业务唯一标识',
  `session_id`        VARCHAR(64)   NOT NULL                COMMENT '会话业务唯一标识',
  `client_id`         VARCHAR(64)   DEFAULT NULL            COMMENT '客户端标识',
  `token_fingerprint` CHAR(64)      NOT NULL                COMMENT '刷新令牌 SHA-256 指纹（原值不落库）',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_oauth_client` (
  `id`                 BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  `client_id`          VARCHAR(64)   NOT NULL                COMMENT '客户端标识',
  `client_name`        VARCHAR(128)  NOT NULL                COMMENT '客户端名称',
  `client_secret_hash` VARCHAR(255)  DEFAULT NULL            COMMENT '客户端密钥 BCrypt 哈希（公开客户端可为空）',
  `client_type`        VARCHAR(32)   NOT NULL                COMMENT '客户端类型：public,confidential,internal',
  `redirect_uris`      TEXT          DEFAULT NULL            COMMENT '回调地址列表（JSON 数组序列化）',
  `grant_types`        VARCHAR(255)  NOT NULL                COMMENT '授权类型列表（逗号分隔）',
  `scopes`             VARCHAR(255)  DEFAULT NULL            COMMENT '授权范围列表（空格分隔）',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_mfa_challenge` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `verify_code_hash` CHAR(64)      DEFAULT NULL            COMMENT '验证码 SHA-256 哈希值（原值不落库）',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_risk_event` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `hit_rules`        VARCHAR(1024) DEFAULT NULL            COMMENT '命中规则列表（逗号分隔）',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_audit_log` (
  `id`                BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `request_snapshot`  TEXT          DEFAULT NULL            COMMENT '请求快照（JSON 格式脱敏存储）',
  `event_time`        TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '事件时间',
  `description`       VARCHAR(255)  DEFAULT NULL            COMMENT '备注',
  `create_time`       TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by`         VARCHAR(64)   DEFAULT NULL            COMMENT '创建者',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_merge_request` (
  `id`                     BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `conflict_identity_hash` CHAR(64)      NOT NULL                COMMENT '冲突标识 SHA-256 哈希值',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_deactivation_request` (
  `id`                       BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_invitation_relation` (
  `id`                    BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_owner_cert_state` (
  `id`               BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ciam_user_consent` (
  `id`              BIGINT        NOT NULL AUTO_INCREMENT COMMENT '主键',
