...
import static net.hwyz.iov.cloud.framework.web.context.SecurityContextHolder.setUserId;
...
import org.mockito.Mockito;import net.hwyz.iov.cloud.sec.ciam.service.application.LoginResult;
...
import net.hwyz.iov.cloud.sec.ciam.service.controller.open.OpenOidcController;
...
class CoreAuthenticationLoopVerificationTest {
    ...
    class EmailLoginLoop {
        ...
        void emailPasswordLogin() {
            ...
            when(credentialRepository.findByUserIdAndType(eq("U002"), anyString()))
                    .thenReturn(Optional.of(new CiamUserCredentialDo() {{
    ...
    class MfaLoop {
        ...
        void verifyMfaChallenge_pass() {
            ...
            challenge.setVerifyCodeHash(
                    TokenDigest.fingerprint(correctCode));
        ...
        void verifyMfaChallenge_fail() {
            ...
            challenge.setExpireTime(Instant.now().plusSeconds(5 * 60));
            challenge.setVerifyCodeHash(
                    TokenDigest.fingerprint("654321"));
    ...
    class DeactivationLoop {
        ...
        void executeDeactivation() {
            ...
            verify(deactivationRequestRepository).updateByDeactivationRequestId(argThat(r ->
                    r.getExecuteStatus() == ExecuteStatus.EXECUTED.getCode()));
        }
    }
}
